...
<!-- Materialize Modal Update -->
	<div id="loadTypesModal" class="modal " style = "overflow:visible" >
			...
			<div class="modal-footer">
				<a id="typeCreate" onclick="addTypeToProject({{.ProjectID}}, $('#typeID').val(), {{.Title}})"  class="btn green white-text waves-effect waves-light btn-flat modal-action modal-close" >Set</a>
...
<div id="confirmUnassignModal" class="modal" >
			...
			<div class="modal-footer">
				<a id="resourceUnassign"  onclick="unassignProjectType($('#projectIDToDelete').val(),$('#typeIDToDelete').val(),{{.Title}})" class="btn green white-text waves-effect waves-light btn-flat modal-action modal-close" >Yes</a>
